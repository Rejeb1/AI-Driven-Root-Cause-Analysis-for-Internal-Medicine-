...
python3 scripts/eval_real_cases.py   # 4 real patients from published PMC case reports
```
...
**Real-case evaluation.** `dxagent.datasets.real_cases` holds 4 patients
...
n=4. No clinician reviewed the extraction. See the module docstring for
