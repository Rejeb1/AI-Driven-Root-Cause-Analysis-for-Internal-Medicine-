...
an unfinished feature — because 94 of its 153 likelihoods are invented, no
...
**94 of 153 likelihoods are invented.** That is the number, stated on its own
line, because it is the most important fact about this project.

The remaining 59 carry a citation: 13 counted from the DDXPlus simulator, 33
...
|---|---|
| complete | 9/10 |
| 94 invented deleted | **1/10** |
| 59 sourced deleted, invented kept | 7/10 |
...
**Bounded by measurement rather than blocked:** the 94 remaining invented
