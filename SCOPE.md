...
recorded.** 40% of the 153 likelihoods carry a citation — 12 from DDXPlus, 13
from the Merck Manual's narrative text, 36 from published cohorts.
...
**The likelihood tables are still mostly invented — 92 of 153.** UMLS was
...
strength: 36 frequencies from published cohorts (Miniati 2012, Zègre-Hemsey
...
**Most of the remaining 92 are not sourceable from a reference text at all.**
...
"40% sourced" with no hint that the priors were not part of that fraction at
