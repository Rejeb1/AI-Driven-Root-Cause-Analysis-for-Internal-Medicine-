...
recorded.** 34% of the 153 likelihoods carry a citation — 15 from DDXPlus, 14
from the Merck Manual's narrative text, 23 from published cohorts.
...
**The likelihood tables are still mostly invented — 101 of 153.** UMLS was
...
strength: 23 frequencies from published cohorts (Miniati 2012, Zègre-Hemsey
2018, Noorain 2016, StatPearls), 15 counted in the DDXPlus simulator, and 14
converted from
...
**Most of the remaining 101 are not sourceable from a reference text at all.**
...
"34% sourced" with no hint that the priors were not part of that fraction at
