...
recorded.** 38% of the 153 likelihoods carry a citation — 13 from DDXPlus, 13
from the Merck Manual's narrative text, 32 from published cohorts.
...
**The likelihood tables are still mostly invented — 95 of 153.** UMLS was
...
strength: 32 frequencies from published cohorts (Miniati 2012, Zègre-Hemsey
...
**Most of the remaining 95 are not sourceable from a reference text at all.**
...
"38% sourced" with no hint that the priors were not part of that fraction at
