...
recorded.** 35% of the 153 likelihoods carry a citation — 14 from DDXPlus, 14
from the Merck Manual's narrative text, 26 from published cohorts.
...
**The likelihood tables are still mostly invented — 99 of 153.** UMLS was
...
strength: 26 frequencies from published cohorts (Miniati 2012, Zègre-Hemsey
2018, Noorain 2016, StatPearls), 14 counted in the DDXPlus simulator, and 14
converted from
...
**Most of the remaining 99 are not sourceable from a reference text at all.**
...
"35% sourced" with no hint that the priors were not part of that fraction at
