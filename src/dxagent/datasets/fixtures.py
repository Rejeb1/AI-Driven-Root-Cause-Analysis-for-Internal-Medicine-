...
_SOURCED: dict[tuple[str, str], tuple[float, LikelihoodSource]] = {
    ...
    ("pulmonary_embolism", "dyspnoea_at_rest"): measured(
        0.719,
        Citation("DDXPLUS", "E_66", "3793 of 5277 pulmonary_embolism patients"),
    ),
    ...
    ("community_acquired_pneumonia", "dyspnoea_at_rest"): measured(
        0.691,
        Citation("DDXPLUS", "E_66", "3308 of 4786 community_acquired_pneumonia patients"),
    ),
    ...
    ("acute_coronary_syndrome", "dyspnoea_at_rest"): measured(
        0.646,
        Citation("DDXPLUS", "E_66", "5156 of 7982 acute_coronary_syndrome patients"),
    ),
    ...
    ("acute_pulmonary_oedema", "dyspnoea_at_rest"): measured(
        0.795,
        Citation("DDXPLUS", "E_66", "2839 of 3569 acute_pulmonary_oedema patients"),
    ),
    ...
    ("copd_exacerbation", "dyspnoea_at_rest"): measured(
        0.759,
        Citation("DDXPLUS", "E_66", "2862 of 3769 copd_exacerbation patients"),
    ),
    ...
    ("asthma_exacerbation", "dyspnoea_at_rest"): measured(
        0.852,
        Citation("DDXPLUS", "E_66", "3475 of 4079 asthma_exacerbation patients"),
    ),
    ("pericarditis", "pleuritic_pain"): measured(
        0.690,
        Citation("DDXPLUS", "E_220", "2965 of 4300 pericarditis patients"),
    ),
    ("pericarditis", "dyspnoea_at_rest"): measured(
        0.620,
        Citation("DDXPLUS", "E_66", "2664 of 4300 pericarditis patients"),
    ),
    ("panic_attack", "palpitations"): measured(
        0.726,
        Citation("DDXPLUS", "E_155", "3428 of 4724 panic_attack patients"),
    ),
    ("panic_attack", "dyspnoea_at_rest"): measured(
        0.703,
        Citation("DDXPLUS", "E_66", "3319 of 4724 panic_attack patients"),
    ),
}
